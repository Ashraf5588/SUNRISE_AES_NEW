...
inCorrect.push({
 ...
 roll: inCorrectData.map(item => item.roll),
...
Correct.push({
  ...
  roll: CorrectData.map(item => item.roll),
...
fifty.push({
  ...
  roll: fiftyData.map(item => item.roll),
...
CorrectAbove50.push({ 
  ...
  roll: CorrectAbove50Data.map(item => item.roll),
...
CorrectBelow50.push({
  ...
  roll: CorrectBelow50Data.map(item => item.roll),
